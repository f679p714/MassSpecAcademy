...
Your local copy, called "origin," is different than the version on GitHub owned by EARTHTIME, called "upstream." Your copy is a little sandbox where you can change anything you want --- you could mess up your GitHub repository without affecting the larger project or its web presence. You can undo any of your local edits, and you can also keep your repository up-to-date with upstream changes from others while you work. 

The feature branch we're about to create in "origin," your own copy of the Mass Spec Academy repository, will be a place that you create and edit your Mass Spec Academy content. You can create a new branch for each contribution you plan to make. For instance, you could make a branch for a project like "Start TIMS applications chapter" or "Edit background sections." 

When you're at a place with your project where you want to merge them with the "upstream" main repository, you will create a Pull Request using the instructions below. This alerts the project maintainers (currently [Stephen Cox](https://github.com/stephen-e-cox) and [Noah McLean](https://github.com/noahmclean)) that your content is ready. The maintainers can review your content, make suggestions or edits with the opportunity for a group discussion, and then merge your content into the main project. The merge will become visible to everyone else working on the project, and it will automatically update the website and pdf document. Now you can make a new branch for your next set of edits!

#### Create your new feature branch.

In GitHub Desktop, find the "Branches" dropdown menu in the middle of the top of the app window. Click anywhere in the button to make the dropdown menu appear, and click the "New Branch" button at its top right. Type in a name for your feature branch that describes the work you're about to do, or just "testing" if you want to try it out. Hit enter to create your new branch, and you're off to the races.  

::: {.callout-note appearance="simple"}
## Create a new branch on your local repository.

![GitHub Desktop new branch screenshot](){width=60%}\
...
::: {.callout-note appearance="simple"}
## Start of conda new environment from terminal

![Conda new environment starting terminal screenshot](figs/tutorials/Conda%20new%20environment%20starting%20terminal%20screenshot.png){width=60%}\
