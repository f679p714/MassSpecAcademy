...
::: {.callout-note appearance="simple"}
## GitHub website screenshot of starting a draft pull request
...
When you're ready for your content to be added to the webpage, go back to [https://github.com/EARTHTIME/MassSpecAcademy/pulls](https://github.com/EARTHTIME/MassSpecAcademy/pulls), choose your pull request, and then click the "Ready for review" button.

::: {.callout-note appearance="simple"}
## GitHub website screenshot of the Ready for review button
...
This lets Stephen and Noah know that it's time for this content to go up on the website!
